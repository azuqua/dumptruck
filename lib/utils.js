...
module.exports.oracleToKnex = function(oracle) {
  console.log('oracle datatype. Did I miss any?', oracle);
  switch(oracle) {
    case this.constants.oracle.char:
    case this.constants.oracle.varchar:
    case this.constants.oracle.varchar2:
    case this.constants.oracle.nvarchar2:
      return this.constants.knexType.string;
    case this.constants.oracle.numeric:
    case this.constants.oracle.number:
      return this.constants.knexType.decimal;
    case this.constants.oracle.float:
      return this.constants.knexType.float;
    case this.constants.oracle.integer:
    case this.constants.oracle.int:
      return this.constants.knexType.integer;
    case this.constants.oracle.timestamp:
    case this.constants.oracle.date:
      return this.constants.knexType.timestamp;
    default:
      return oracle;
  }
