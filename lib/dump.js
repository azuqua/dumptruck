...
function _initializeSQL(_client) {
  ...
  console.log(_statements.get.columns());
};
...
// some function that just handles the massaging of data so that it is null filtered
// thats some that needs to be written
